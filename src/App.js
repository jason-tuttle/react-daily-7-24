...
class BaseLayout extends Component {
  render() {
    return (
      <div className="base-layout">This should house Header and Footer components and be able to house any children components.
        {this.props.children}
      </div>
    );
  }
...
class DisplayComponent extends Component {
  render() {
    return (
      <div className="say-what" >{this.props.sayWhat}</div>
    );
  }
}
